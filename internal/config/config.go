...
type RuntimeConfig struct {
	...
	PromptRiskGuardEnabled              *bool             `json:"prompt_risk_guard_enabled,omitempty"`
	PromptBlockRules                    []PromptBlockRule `json:"prompt_block_rules,omitempty"`
