...
func TestChatCompletionsInvalidJSONDoesNotAcquireAccount(t *testing.T) {
...
func TestChatCompletionsOversizedPromptDoesNotAcquireAccount(t *testing.T) {
	authStub := &preflightAuthStub{}
	body, err := json.Marshal(map[string]any{
		"model": "deepseek-v4-flash",
		"messages": []any{
			map[string]any{"role": "user", "content": strings.Repeat("x", 60001)},
		},
	})
	if err != nil {
